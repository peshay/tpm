...
## Hardening Notes
- This module talks to a password manager; treat all credentials, keys, and password payloads as highly sensitive.
- Never commit credentials or paste them into issues, logs, or test fixtures.
- Use private/public key authentication where possible.
