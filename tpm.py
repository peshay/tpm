...
class TpmApi(object):
    ...
    def return_collection(self, path):
    ...
    def list_projects(self):
        return return_collection('projects.json')

    def list_projects_archived(self):
        return return_collection('projects/archived.json')

    def list_projects_favorite(self):
        return return_collection('projects/favorite.json')

    def list_projects_search(self, searchstring):
        return return_collection('projects/search/%s.json'
                                 % searchstring)

    # Show a project
    # http://teampasswordmanager.com/docs/api-projects/#show_project
    def show_project(self, ID):
        return return_collection('projects/%s.json' % ID)
    ...
    def list_passwords_of_project(self, ID):
        return return_collection('projects/%s/passwords.json' % ID)
    ...
    def list_user_access_on_project(self, ID):
        return return_collection('projects/%s/security.json' % ID)
